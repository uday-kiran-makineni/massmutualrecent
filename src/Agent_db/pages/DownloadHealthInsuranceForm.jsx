...
const DownloadHealthInsuranceForm = () => {
  ...
  doc.text('Health Insurance Form', 105, 20, { align: 'center' });
  ...
  const premiumFields = [
    'premiumAmount', 'paymentFrequency', 'claimLimit'
  ];
  ...
  // Save the PDF
  doc.save('Health_Insurance_Form.pdf');
  };
...
export default DownloadHealthInsuranceForm;
